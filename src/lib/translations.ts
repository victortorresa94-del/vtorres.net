    ...
    en: {
        ...
        freelance: {
            ...
            items: {
                ...
                music: {
                    title: "94 Music",
                    desc: "Digital medium and agency. Viral content creation (+5M views, 16k community) and booking management. I have organized and sound-engineered more than 100 music events."
                },
                condor: {
                    title: "Condor Music",
        ...
        procesos: {
            ...
            naturalStandardization: {
                title: "Standardization as a Natural Skill",
                subtitle: "Before documenting processes, I created them to survive operationally.",
                intro: "I didn't learn to organize chaos in business school. I discovered I had been doing it all my life. My brain detects patterns where others see isolated tasks. When something repeats, I turn it into a system.",
                cases: [
                    {
                        context: "Administration & Purchasing",
                        company: "Reauxi",
                        problem: "Unsustainable administrative volume and reliance on memory.",
                        solution: "Creation of logical validation sequences and daily management routines.",
                        icon: "FileText"
                    },
                    {
                        context: "Logistics & Warehouse",
                        company: "Denetic",
                        problem: "Chaotic warehouse without defined locations or stock control.",
                        solution: "Definition of physical flows, fixed locations, and replenishment rules.",
                        icon: "Package"
                    },
                    {
                        context: "Event Production",
                        company: "Live Music",
                        problem: "High pressure, variability, and zero margin for error.",
                        solution: "Setup checklists, booking flows, and crisis protocols.",
                        icon: "Music"
                    }
                ],
                closing: "I am not a consultant who just applies frameworks. I have a systemic mindset. I see processes where others see tasks."
            },
            changeManagement: {
            ...
            career: {
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        title: "Live Music Manager",
                        role: "94 Music",
                        desc: "Lideratge i execució de més de 100 esdeveniments musicals en viu. Gestió integral: producció, logística, booking i màrqueting digital."
                    },
                    {
                        year: "2023 - 2024",
                        title: "CMO & Marketing AI",
                    ...
                    },
                    {
                        ...
                        role: "HTW Spain",
                        desc: "Primera etapa professional. Creació d'identitat de marca, disseny de catàlegs tècnics i suport en màrqueting industrial."
                    },
                    {
                        year: "2013",
                        title: "Business Manager (Operacions)",
                        role: "Denetic",
                        desc: "Màster pràctic en gestió integral de negoci: logística, compres a la Xina, gestió de magatzem, facturació i instal·lacions tècniques. Responsable total de l'operativa de l'empresa (excloent vendes)."
                    }
                ]
            },
            achievements: {
