    ...
    return (
        <div className="space-y-20">
            ...
            <div className="max-w-5xl mx-auto space-y-8">
                <h3 className="text-2xl md:text-3xl font-medium text-white text-center mb-12">
                    ...
                    {content.responsibilities.map((resp: any, i: number) => (
                        ...
                        >
                            <div className="flex items-start gap-3">
                                <span className="text-2xl font-medium text-[#82ff1f]">{i + 1}</span>
                                <div>
                                    <h4 className="text-lg font-medium text-white mb-2">{resp.title}</h4>
            ...
            <div className="bg-[#82ff1f]/5 border border-[#82ff1f]/20 rounded-2xl p-8 md:p-12 space-y-6 max-w-4xl mx-auto">
                <h3 className="text-2xl font-medium text-white text-center">{content.position.title}</h3>
            ...
            <div className="text-center">
                <p className="text-2xl md:text-3xl text-white font-medium max-w-3xl mx-auto leading-tight">
                    {content.closure}
                </p>
            </div>
        </div>
