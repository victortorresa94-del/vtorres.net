  ...
  const achievements = [
    {
      ...
      metric: "30% Eficiencia | 3 meses ÔåÆ 1 mes",
    ...
    },
    {
      ...
      desc: "Lider├® la creaci├│n de 'EME Academy', la academia interna de la agencia. Objetivo: unificar conocimiento 360┬║ (que el c├ímara entienda una landing, que el dev entienda m├®tricas). Creaci├│n de temarios, env├¡o de cursos y evaluaci├│n de personal.",
    ...
    {
      id: 3,
      title: "Gesti├│n Proyecto 1MÔé¼ Mercedes",
      role: "Financial & Resource Management",
      desc: "Gesti├│n integral de un proyecto de 1.000.000Ôé¼ para Mercedes en Reauxi. Control financiero milim├®trico en Excel complejo (gastos, personal, material). Gesti├│n de compras internacionales y contrataci├│n de personal para asegurar la viabilidad econ├│mica del proyecto.",
      ...
      <div className="relative z-10">
        ...
        < ExpandableSection id="story" number="00" title="Mi Historia" >
          <div className="space-y-6 text-lg text-zinc-300 font-light leading-relaxed">
            ...
            <p>
              A lo largo de mi trayectoria he trabajado en <strong className="text-white">pr├ícticamente todos los departamentos de una empresa</strong> ÔÇöventas, compras, contabilidad, log├¡stica, marketing y gerenciaÔÇö, lo que me ha permitido desarrollar una visi├│n global y muy pr├íctica de c├│mo funcionan realmente las organizaciones y cu├íles son sus necesidades operativas reales.
            </p>
            <p>
              Durante m├ís de ocho a├▒os trabaj├® en marketing digital y ventas. En 2022 di un paso clave al asumir mi primer rol como <strong className="text-white">Project Manager y l├¡der de procesos</strong> en una agencia de marketing, donde dise├▒├® desde cero la estructura operativa, logrando <span className="text-[#82ff1f]">mejorar la eficiencia global en torno a un 30%</span>.
            </p>
            <p>
              Tras la pandemia me traslad├® a Colombia sin un plan definido. All├¡ cre├® y gestion├® m├║ltiples emprendimientos propios que se convirtieron en un <strong className="text-white">aut├®ntico m├íster pr├íctico en negocio y ejecuci├│n bajo presi├│n</strong>.
            </p>
            <p>
              Descubr├¡ que mi fortaleza es la <strong className="text-white">capacidad para organizar el caos y mejorar sistemas</strong>. La irrupci├│n de ChatGPT me llev├│ a especializarme en <span className="text-[#82ff1f]">Inteligencia Artificial aplicada</span>, integr├índola de forma pr├íctica en proyectos reales.
            </p>
            <p>
        ...
        < ExpandableSection id="career" number="01" title="Trayectoria Profesional" >
          <div className="relative border-l border-white/10 ml-3 space-y-12 pl-8">
            <TimelineItem
              ...
              role="Aut├│nomo"
              desc="Implementaci├│n de soluciones de IA para empresas, consultor├¡a estrat├®gica de marketing y direcci├│n de proyectos tecnol├│gicos."
            />
            <TimelineItem
              year="2023 - 2025"
              title="Fundador / Director de Eventos"
              role="94 Music"
              desc="Liderazgo y ejecuci├│n de m├ís de 100 eventos musicales en vivo. Gesti├│n integral: producci├│n, log├¡stica, booking y marketing digital."
            />
            <TimelineItem
              year="2023 - 2024"
              title="CMO & Marketing AI"
              role="Kmeleon"
              desc="Estrategia de marca internacional y Go-to-Market para soluciones de IA. Automatizaci├│n de procesos de venta y narrativa tecnol├│gica."
            />
            <TimelineItem
              year="2023"
              title="Netsuite Oracle Project Manager"
              role="DisrupTT"
              desc="Liderazgo en la implementaci├│n del ERP Oracle Netsuite. Coordinaci├│n de equipos t├®cnicos y consultor├¡a de procesos."
            />
            <TimelineItem
              year="2022 - 2023"
              title="Growth Partner & BizDev"
              role="Konektor"
              desc="Desarrollo de negocio y expansi├│n estrat├®gica. Implementaci├│n de ventas consultivas apoyadas en herramientas de IA."
            />
            <TimelineItem
              year="2022"
              title="PM & L├¡der de Procesos"
              role="Eme Growth Agency"
              desc="Dise├▒o y ejecuci├│n de la estructura operativa de la agencia. Liderazgo de equipos multidisciplinares y creaci├│n de 'EME Academy'."
            />
            <TimelineItem
              year="2021"
              title="Marketing Account Manager"
              role="Growbox Digital"
              desc="Estrategia GTM para 'Totemica' (Skincare Miami). Branding, b├║squeda de proveedores internacionales y lanzamiento exitoso al mercado."
            />
            <TimelineItem
              year="2019"
              title="Jefe de Log├¡stica"
              role="Mondo Convenienza"
              desc="Coordinaci├│n y optimizaci├│n de flujos de trabajo log├¡sticos y liderazgo de equipos operativos."
            />
            <TimelineItem
              year="2018"
              title="Responsable de Marketing & Compras"
              role="Reauxi"
              desc="Gesti├│n de proyecto cr├¡tico para Mercedes (1MÔé¼). Responsable de compras internacionales, facturaci├│n y registro en ERP."
            />
            <TimelineItem
              year="2017"
              title="Business Manager (Operaciones)"
              role="Denetic"
              desc="M├íster pr├íctico en gesti├│n integral de negocio: log├¡stica, compras en China, gesti├│n de almac├®n, facturaci├│n e instalaciones t├®cnicas. Responsable total de la operativa de la empresa (excluyendo ventas)."
            />
            <TimelineItem
              year="2015 - 2017"
              title="Dise├▒ador Gr├ífico & Marketing B2B"
              role="HTW Spain"
              desc="Primera etapa profesional. Creaci├│n de identidad de marca, dise├▒o de cat├ílogos t├®cnicos y soporte en marketing industrial."
            />
          </div>
        </ExpandableSection >
        ...
        < ExpandableSection id="skills" number="03" title="Skills" >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
              ...
              <div className="p-6 rounded-2xl bg-gradient-to-br from-[#82ff1f]/10 to-transparent border-2 border-[#82ff1f]/30 relative overflow-hidden group hover:border-[#82ff1f]/50 transition-all">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-xs text-zinc-400 leading-relaxed">Visi├│n estrat├®gica para liderar equipos y traducir objetivos de negocio en sistemas funcionales.</p>
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-gradient-to-br from-[#82ff1f]/10 to-transparent border-2 border-[#82ff1f]/30 relative overflow-hidden group hover:border-[#82ff1f]/50 transition-all">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-xs text-zinc-400 leading-relaxed">Estrategias GTM, dise├▒o de funnels de conversi├│n y posicionamiento de marca.</p>
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-gradient-to-br from-[#82ff1f]/10 to-transparent border-2 border-[#82ff1f]/30 relative overflow-hidden group hover:border-[#82ff1f]/50 transition-all">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-xs text-zinc-400 leading-relaxed">Gesti├│n de cuentas (KAM), fidelizaci├│n y traducci├│n de necesidades t├®cnicas a lenguaje de negocio.</p>
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-gradient-to-br from-[#82ff1f]/10 to-transparent border-2 border-[#82ff1f]/30 relative overflow-hidden group hover:border-[#82ff1f]/50 transition-all">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-xs text-zinc-400 leading-relaxed">De la estrategia a la implementaci├│n t├®cnica real. Ciclo completo de proyectos de IA aplicada.</p>
                </div>
              </div>
          ...
          < div className="space-y-8" >
            ...
            < div >
              <h3 className="text-sm font-bold text-[#82ff1f] mb-4 flex items-center gap-2">
                <ClipboardList size={16} /> Gesti├│n de Proyectos y Agilismo
              </h3>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
                ...
                <div className="px-4 py-3 rounded-xl bg-black/40 border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                  <p className="text-sm font-medium text-white">Gesti├│n de Riesgos</p>
                </div>
                <div className="px-4 py-3 rounded-xl bg-black/40 border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                  <p className="text-sm font-medium text-white">Planificaci├│n Estrat├®gica</p>
                </div>
              </div>
            </div >
            ...
            <div>
              <h3 className="text-sm font-bold text-[#82ff1f] mb-4 flex items-center gap-2">
                <Users size={16} /> Relaci├│n con Cliente & Gesti├│n
              </h3>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
                <div className="px-4 py-3 rounded-xl bg-black/40 border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                ...
                <div className="px-4 py-3 rounded-xl bg-black/40 border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                  <p className="text-sm font-medium text-white">Atenci├│n al Cliente</p>
                </div>
                <div className="px-4 py-3 rounded-xl bg-black/40 border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                  <p className="text-sm font-medium text-white">Fidelizaci├│n</p>
                </div>
                <div className="px-4 py-3 rounded-xl bg-black/40 border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                  <p className="text-sm font-medium text-white">Resoluci├│n de Conflictos</p>
                </div>
                <div className="px-4 py-3 rounded-xl bg-black/40 border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                  <p className="text-sm font-medium text-white">Comunicaci├│n Asertiva</p>
                </div>
              </div>
            </div>
            ...
            <div >
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
                ...
                <div className="px-4 py-3 rounded-xl bg-black/40 border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                  <p className="text-sm font-medium text-white">Negociaci├│n B2B</p>
                </div>
                <div className="px-4 py-3 rounded-xl bg-black/40 border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                  <p className="text-sm font-medium text-white">Estrategia GTM</p>
                </div>
                <div className="px-4 py-3 rounded-xl bg-black/40 border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                  <p className="text-sm font-medium text-white">Visi├│n de Producto</p>
                </div>
                <div className="px-4 py-3 rounded-xl bg-black/40 border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                  <p className="text-sm font-medium text-white">Gesti├│n de Stakeholders</p>
                </div>
              </div>
            </div >
            ...
            < div >
              <h3 className="text-sm font-bold text-[#82ff1f] mb-4 flex items-center gap-2">
                <Code size={16} /> Habilidades T├®cnicas
              </h3>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
                <div className="px-4 py-3 rounded-xl bg-black/40 border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                ...
                <div className="px-4 py-3 rounded-xl bg-black/40 border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                  <p className="text-sm font-medium text-white">Integraci├│n de Sistemas</p>
                </div>
                <div className="px-4 py-3 rounded-xl bg-black/40 border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                  <p className="text-sm font-medium text-white">Automatizaci├│n de Procesos</p>
                </div>
                <div className="px-4 py-3 rounded-xl bg-black/40 border border-white/5 hover:border-[#82ff1f]/20 transition-all">
          ...
          <div className="mt-12 pt-8 border-t border-white/10">
            ...
            <div className="space-y-8">
              ...
              <div>
                <h4 className="text-sm font-bold text-zinc-400 mb-3 uppercase tracking-wider">IA & Automatizaci├│n Avanzada</h4>
              ...
              {/* Stack Creativo */}
              <div>
                <h4 className="text-sm font-bold text-zinc-400 mb-3 uppercase tracking-wider">Dise├▒o & Contenido</h4>
                <div className="flex flex-wrap gap-2">
              ...
              <div>
                <h4 className="text-sm font-bold text-zinc-400 mb-3 uppercase tracking-wider">Desarrollo Web & C├│digo</h4>
                <div className="flex flex-wrap gap-2">
        ...
        < ExpandableSection id="ia" number="04" title="Experiencia IA" >
          <div className="space-y-8">
            <p className="text-zinc-300 text-lg font-light leading-relaxed mb-6">
              Mi enfoque en la Inteligencia Artificial combina la <strong className="text-white">visi├│n estrat├®gica con la capacidad de ejecuci├│n t├®cnica</strong>. Me especializo en el ciclo completo de vida del proyecto: desde el dise├▒o de la arquitectura de la soluci├│n hasta la implementaci├│n t├®cnica de agentes y la orquestaci├│n de workflows complejos. Act├║o como el puente que traduce los objetivos de negocio en sistemas operativos eficientes.
            </p>
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <ProjectRow
                ...
                desc="Desarrollo de un agente de prospecci├│n automatizado: scraping web para identificar clientes potenciales (wedding planners), extracci├│n autom├ítica de datos de contacto, almacenamiento en Excel y env├¡o de secuencias de correo personalizadas. Sistema completo de captaci├│n de leads sin intervenci├│n manual."
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div className="p-5 bg-black/40 rounded-2xl border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div>
                      <h4 className="font-bold text-white text-sm mb-1">N├║ria - Agente Rostisseria</h4>
                      <p className="text-xs text-zinc-400">Agente telef├│nico que gestiona pedidos retail, consulta stock en tiempo real y registra pedidos autom├íticamente</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-5 bg-black/40 rounded-2xl border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-zinc-400">Generador de avatares consistentes fotorrealistas para marcas, thumbnails y creatividades est├íticas</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-5 bg-black/40 rounded-2xl border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-zinc-400">Web app de edici├│n: eliminaci├│n de objetos/fondos (Inpainting), restauraci├│n y mejora de calidad en segundos</p>
                    </div>
                  </div>
                </div>

                {/* Gestor de Part├¡culas 3D */}
                <div className="p-5 bg-black/40 rounded-2xl border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                  <div className="flex items-start gap-3 mb-3">
                    <div className="p-2 bg-[#82ff1f]/10 rounded-lg">
                    ...
                    <div>
                      <h4 className="font-bold text-white text-sm mb-1">Gestor de Part├¡culas 3D</h4>
                      <p className="text-xs text-zinc-400">Control de part├¡culas con las manos (Webcam). Vision Tech en el navegador con experiencia visual reactiva</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-5 bg-black/40 rounded-2xl border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-zinc-400">Plataforma EdTech que genera historias visuales educativas con voces clonadas y v├¡deos sint├®ticos</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-5 bg-black/40 rounded-2xl border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-zinc-400">Super app de productividad con NLP avanzado, CTAs inteligentes y planificaci├│n autom├ítica por IA</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-5 bg-black/40 rounded-2xl border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-zinc-400">Red social vertical para m├║sicos: marketplace de segunda mano, servicios y pedidos para conciertos</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-5 bg-black/40 rounded-2xl border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-zinc-400">Agente de atenci├│n al paciente 24/7: gesti├│n de citas, triaje inteligente y resoluci├│n de dudas m├®dicas</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {/* --- MIS N├ÜMEROS --- */}
        < ExpandableSection id="numbers" number="05" title="Mis N├║meros" >
          <div className="flex overflow-x-auto pb-6 gap-6 snap-x snap-mandatory md:grid md:grid-cols-2 lg:grid-cols-4 md:pb-0">
            ...
            <NumberCard className="min-w-[280px] md:min-w-0 snap-center" icon={<Target size={24} />} value="+1M Ôé¼" label="Presupuesto" description="Gestionado en proyectos." />
        ...
        {/* --- FORMACI├ôN --- */}
        < ExpandableSection id="education" number="06" title="Formaci├│n & Certificaciones" >
          <div className="relative border-l border-white/10 ml-3 space-y-12 pl-8">
            ...
            <TimelineItem
              ...
              role="Grado Superior"
              desc="Formaci├│n integral en estrategias de comercializaci├│n, investigaci├│n de mercados, log├¡stica y gesti├│n de puntos de venta. Base acad├®mica para el desarrollo de estrategias de negocio."
            />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-black/40 rounded-xl border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <h4 className="font-bold text-white">Certificaci├│n SAP</h4>
                  </div>
                  <p className="text-sm text-zinc-400">Formaci├│n oficial impartida directamente por <strong className="text-white">SAP</strong> (3 d├¡as intensivos). Especializaci├│n en procesos corporativos y m├│dulos log├¡sticos.</p>
                </div>
                ...
                <div className="p-4 bg-black/40 rounded-xl border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                  ...
                  <p className="text-sm text-zinc-400">Formaci├│n oficial de <strong className="text-white">Oracle</strong> (2 semanas de inmersi├│n total). Administraci├│n, configuraci├│n y flujos de trabajo en ERP Cloud.</p>
                </div>
                ...
                <div className="p-4 bg-black/40 rounded-xl border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                  ...
                  <p className="text-sm text-zinc-400">Certificaci├│n profesional de Google. Metodolog├¡as ├ügiles, gesti├│n del cambio y liderazgo de proyectos complejos.</p>
                </div>
                ...
                <div className="p-4 bg-black/40 rounded-xl border border-white/5 hover:border-[#82ff1f]/20 transition-all">
                  ...
                  <p className="text-sm text-zinc-400">Cursos de especializaci├│n en IA Generativa, Cloud Computing y nuevas tecnolog├¡as del ecosistema Google.</p>
                </div>
            ...
            <div>
              ...
              <div className="flex overflow-x-auto pb-6 gap-4 snap-x snap-mandatory md:grid md:grid-cols-2 md:pb-0">
                ...
                <ProjectRow
                  ...
                  desc="Medio digital y agencia. Creaci├│n de contenido viral (+5M views, 16k comunidad) y gesti├│n de booking. He organizado y sonorizado m├ís de 100 eventos musicales."
                ...
                <ProjectRow
                  ...
                  role="Founder"
                  desc="Ecommerce de joyer├¡a masculina creado a coste cero. Estrategia de crecimiento org├ínico que permiti├│ ventas internacionales en 8 pa├¡ses y sostener el negocio."
        ...
        < ExpandableSection id="seeking" number="08" title="Mis Objetivos" >
          <div className="max-w-4xl space-y-8 text-lg text-zinc-300 font-light leading-relaxed">
            ...
            <p className="italic text-zinc-400 border-l-2 border-[#82ff1f] pl-4">
              "Busco algo m├ís que un empleo; busco un equipo, una cultura y una 'familia' profesional con la que crecer."
            </p>
          </div>
        </ExpandableSection >
          ...
          <div className="max-w-6xl mx-auto px-6 relative z-10">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-zinc-400 max-w-2xl mx-auto">
                ┬┐Buscas alguien que entienda tanto la estrategia como la ejecuci├│n? Conectemos.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              >
                <h3 className="text-2xl font-heading font-medium text-white mb-6">Env├¡ame un mensaje</h3>
                <form
                ...
                <div className="p-8 rounded-3xl bg-gradient-to-br from-white/5 to-transparent border border-white/10 hover:border-[#82ff1f]/30 transition-all group">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-zinc-400 mb-4 text-sm">Escr├¡beme directamente</p>
                      <a
                ...
                <div className="p-8 rounded-3xl bg-gradient-to-br from-white/5 to-transparent border border-white/10 hover:border-[#82ff1f]/30 transition-all group">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-zinc-400 mb-4 text-sm">Prefiero hablar por tel├®fono</p>
                      <a
